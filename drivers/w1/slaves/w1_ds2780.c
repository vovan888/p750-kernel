 ...
 * by Vladimir Ananiev <vovan888@gmail.com>
 *
...
static ssize_t w1_ds2780_read_bin(struct kobject *kobj,
...
static struct w1_family w1_ds2780_family = {
	.fid = W1_FAMILY_DS2760,	/* FIXME */
	.fops = &w1_ds2780_fops,
};

static int __init w1_ds2780_init(void)
{
	printk(KERN_INFO "1-Wire driver for the DS2780 battery monitor "
	       " chip  - (c) 2009 Vladimir Ananiev\n");
	idr_init(&bat_idr);
...
MODULE_DESCRIPTION("1-wire Driver for Dallas 2780 battery monitor chip");
